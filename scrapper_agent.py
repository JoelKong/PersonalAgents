...
async def highlight_clickables(page):
    interactable_elements = await page.evaluate('''() => {
        const elements = document.querySelectorAll('div[id^="PTNUI_LAND_REC14$0_row_"], li[id^="win1divPTGP_STEPS_L1_row"], a, button, input, textarea');
...
async def scrapper_agent(content, messages):
    ...
    async with async_playwright() as p:
        user_data_dir = "C:/Users/Joel/AppData/Local/Google/Chrome/User Data"  # Specify the path to your Chrome user data directory here
