...
async def main_agent(content, page):
    ...
    tools = [
        ...
        },
        {
            ...
            "function": {
                "name": "scrapper_agent",
                "description": "Handles tasks related to searching for information on the web and retrieving information from screenshots, such as retrieving information about a person or getting data online or finding information in a screenshot. Call this whenever the user wants to search for something or get his school timetable or get something from the page you navigated to, for example when a person asks 'what is my timetable like for this week?'",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "content": {
...
# to do limit length of all messages
# voice to text make into exe